...
class GenreFeatureData:
    ...
    dir_trainfolder = "./GenreClassification/gtzan/_train"
    dir_devfolder = "./GenreClassification/gtzan/_validation"
    dir_testfolder = "./GenreClassification/gtzan/_test"
    dir_all_files = "./GenreClassification/gtzan"

    train_X_preprocessed_data = "./GenreClassification/gtzan/data_train_input.npy"
    train_Y_preprocessed_data = "./GenreClassification/gtzan/data_train_target.npy"
    dev_X_preprocessed_data = "./GenreClassification/gtzan/data_validation_input.npy"
    dev_Y_preprocessed_data = "./GenreClassification/gtzan/data_validation_target.npy"
    test_X_preprocessed_data = "./GenreClassificationgtzan/data_test_input.npy"
    test_Y_preprocessed_data = "./GenreClassification/gtzan/data_test_target.npy"
