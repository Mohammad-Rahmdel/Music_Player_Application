...
if __name__ == "__main__":
    PATH = sys.argv[1] if len(sys.argv) == 2 else "./GenreClassification/audio/classical_music.mp3"
    MODEL = load_model("./GenreClassification/weights/model.json", "./GenreClassification/weights/model_weights.h5")
